...
#region Autogenerated code
	public partial class FileChooserDialog : Gtk.Dialog, Gtk.IFileChooser {
		...
		static Dictionary<GLib.GType, GtkFileChooserDialogClass> class_structs;

		static GtkFileChooserDialogClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkFileChooserDialogClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkFileChooserDialogClass class_struct = (GtkFileChooserDialogClass) Marshal.PtrToStructure (class_ptr, typeof (GtkFileChooserDialogClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkFileChooserDialogClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
