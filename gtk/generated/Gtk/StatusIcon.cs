...
#region Autogenerated code
	public partial class StatusIcon : GLib.Object {
		...
		static Dictionary<GLib.GType, GtkStatusIconClass> class_structs;

		static GtkStatusIconClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkStatusIconClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkStatusIconClass class_struct = (GtkStatusIconClass) Marshal.PtrToStructure (class_ptr, typeof (GtkStatusIconClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkStatusIconClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
