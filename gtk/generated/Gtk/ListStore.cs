...
#region Autogenerated code
	public partial class ListStore : GLib.Object, Gtk.ITreeModel, Gtk.ITreeDragSource, Gtk.ITreeDragDest, Gtk.ITreeSortable {
		...
		static Dictionary<GLib.GType, GtkListStoreClass> class_structs;

		static GtkListStoreClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkListStoreClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkListStoreClass class_struct = (GtkListStoreClass) Marshal.PtrToStructure (class_ptr, typeof (GtkListStoreClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkListStoreClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
