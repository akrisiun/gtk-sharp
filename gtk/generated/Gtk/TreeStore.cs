...
#region Autogenerated code
	public partial class TreeStore : GLib.Object, Gtk.ITreeModel, Gtk.ITreeDragSource, Gtk.ITreeDragDest, Gtk.ITreeSortable {
		...
		static Dictionary<GLib.GType, GtkTreeStoreClass> class_structs;

		static GtkTreeStoreClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTreeStoreClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTreeStoreClass class_struct = (GtkTreeStoreClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTreeStoreClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTreeStoreClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
