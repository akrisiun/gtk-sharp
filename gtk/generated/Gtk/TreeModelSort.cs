...
#region Autogenerated code
	public partial class TreeModelSort : GLib.Object, Gtk.ITreeModel, Gtk.ITreeSortable, Gtk.ITreeDragSource {
		...
		static Dictionary<GLib.GType, GtkTreeModelSortClass> class_structs;

		static GtkTreeModelSortClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTreeModelSortClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTreeModelSortClass class_struct = (GtkTreeModelSortClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTreeModelSortClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTreeModelSortClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
