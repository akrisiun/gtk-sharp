...
#region Autogenerated code
	public partial class TextBuffer : GLib.Object {
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.PixbufInserted = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			PixbufInsertedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).PixbufInserted;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.ChildAnchorInserted = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ChildAnchorInsertedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ChildAnchorInserted;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.DeleteRange = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			DeleteRangeNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).DeleteRange;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.ModifiedChanged = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ModifiedChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ModifiedChanged;
			if (unmanaged == null) return;
		...
		{
			MarkSetNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).MarkSet;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.MarkDeleted = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			MarkDeletedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).MarkDeleted;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.TagApplied = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			TagAppliedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TagApplied;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.UserActionBegun = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			UserActionBegunNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).UserActionBegun;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.UserActionEnded = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			UserActionEndedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).UserActionEnded;
			if (unmanaged == null) return;
		...
		{
			GtkTextBufferClass class_iface = GetClassStruct (gtype, false);
			class_iface.PasteDone = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			PasteDoneNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).PasteDone;
			if (unmanaged == null) return;
		...
		struct GtkTextBufferClass {
			...
			public PixbufInsertedNativeDelegate PixbufInserted;
			public ChildAnchorInsertedNativeDelegate ChildAnchorInserted;
			public DeleteRangeNativeDelegate DeleteRange;
			public ChangedNativeDelegate Changed;
			public ModifiedChangedNativeDelegate ModifiedChanged;
			public MarkSetNativeDelegate MarkSet;
			public MarkDeletedNativeDelegate MarkDeleted;
			public TagAppliedNativeDelegate TagApplied;
			public TagRemovedNativeDelegate TagRemoved;
			public UserActionBegunNativeDelegate UserActionBegun;
			public UserActionEndedNativeDelegate UserActionEnded;
			public PasteDoneNativeDelegate PasteDone;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkTextBufferClass> class_structs;

		static GtkTextBufferClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTextBufferClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTextBufferClass class_struct = (GtkTextBufferClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTextBufferClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTextBufferClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
