...
#region Autogenerated code
	public partial class TreeModelFilter : GLib.Object, Gtk.ITreeModel, Gtk.ITreeDragSource {
		...
		{
			GtkTreeModelFilterClass class_iface = GetClassStruct (gtype, false);
			class_iface.Visible = callback;
		...
		{
			VisibleNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).Visible;
		...
		{
			ModifyNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).Modify;
		...
		struct GtkTreeModelFilterClass {
			public VisibleNativeDelegate Visible;
			public ModifyNativeDelegate Modify;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkTreeModelFilterClass> class_structs;

		static GtkTreeModelFilterClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTreeModelFilterClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTreeModelFilterClass class_struct = (GtkTreeModelFilterClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTreeModelFilterClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTreeModelFilterClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
