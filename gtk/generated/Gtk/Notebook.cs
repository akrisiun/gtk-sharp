...
#region Autogenerated code
	public partial class Notebook : Gtk.Container {
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.SwitchPage = callback;
		...
		{
			SwitchPageNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SwitchPage;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.SelectPage = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			SelectPageNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SelectPage;
		...
		{
			FocusTabNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).FocusTab;
			if (unmanaged == null) return false;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.ReorderTab = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ReorderTabNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ReorderTab;
			if (unmanaged == null) return;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.InsertPage = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			InsertPageNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).InsertPage;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.CreateWindow = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			CreateWindowNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).CreateWindow;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.PageReordered = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			PageReorderedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).PageReordered;
			if (unmanaged == null) return;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.PageRemoved = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			PageRemovedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).PageRemoved;
			if (unmanaged == null) return;
		...
		{
			GtkNotebookClass class_iface = GetClassStruct (gtype, false);
			class_iface.PageAdded = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			PageAddedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).PageAdded;
			if (unmanaged == null) return;
		...
		struct GtkNotebookClass {
			public SwitchPageNativeDelegate SwitchPage;
			public SelectPageNativeDelegate SelectPage;
			public FocusTabNativeDelegate FocusTab;
			public ChangeCurrentPageNativeDelegate ChangeCurrentPage;
			public MoveFocusOutNativeDelegate MoveFocusOut;
			public ReorderTabNativeDelegate ReorderTab;
			public InsertPageNativeDelegate InsertPage;
			public CreateWindowNativeDelegate CreateWindow;
			public PageReorderedNativeDelegate PageReordered;
			public PageRemovedNativeDelegate PageRemoved;
			public PageAddedNativeDelegate PageAdded;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkNotebookClass> class_structs;

		static GtkNotebookClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkNotebookClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkNotebookClass class_struct = (GtkNotebookClass) Marshal.PtrToStructure (class_ptr, typeof (GtkNotebookClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkNotebookClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
