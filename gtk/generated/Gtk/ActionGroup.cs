...
#region Autogenerated code
	public partial class ActionGroup : GLib.Object {
		...
		{
			GtkActionGroupClass class_iface = GetClassStruct (gtype, false);
		...
		static Dictionary<GLib.GType, GtkActionGroupClass> class_structs;

		static GtkActionGroupClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkActionGroupClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkActionGroupClass class_struct = (GtkActionGroupClass) Marshal.PtrToStructure (class_ptr, typeof (GtkActionGroupClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkActionGroupClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
