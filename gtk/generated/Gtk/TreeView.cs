...
#region Autogenerated code
	public partial class TreeView : Gtk.Container, Gtk.IScrollable {
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.RowActivated = callback;
		...
		{
			RowActivatedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).RowActivated;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.TestExpandRow = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			TestExpandRowNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TestExpandRow;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.TestCollapseRow = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			TestCollapseRowNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TestCollapseRow;
			if (unmanaged == null) return false;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.RowExpanded = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			RowExpandedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).RowExpanded;
			if (unmanaged == null) return;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.RowCollapsed = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			RowCollapsedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).RowCollapsed;
			if (unmanaged == null) return;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.ColumnsChanged = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ColumnsChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ColumnsChanged;
			if (unmanaged == null) return;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.CursorChanged = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			CursorChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).CursorChanged;
			if (unmanaged == null) return;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.SelectAll = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			SelectAllNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SelectAll;
			if (unmanaged == null) return false;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.UnselectAll = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			UnselectAllNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).UnselectAll;
			if (unmanaged == null) return false;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.SelectCursorRow = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			SelectCursorRowNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SelectCursorRow;
			if (unmanaged == null) return false;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.ExpandCollapseCursorRow = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ExpandCollapseCursorRowNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ExpandCollapseCursorRow;
			if (unmanaged == null) return false;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.SelectCursorParent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			SelectCursorParentNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SelectCursorParent;
			if (unmanaged == null) return false;
		...
		{
			GtkTreeViewClass class_iface = GetClassStruct (gtype, false);
			class_iface.StartInteractiveSearch = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			StartInteractiveSearchNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).StartInteractiveSearch;
			if (unmanaged == null) return false;
		...
		struct GtkTreeViewClass {
			public RowActivatedNativeDelegate RowActivated;
			public TestExpandRowNativeDelegate TestExpandRow;
			public TestCollapseRowNativeDelegate TestCollapseRow;
			public RowExpandedNativeDelegate RowExpanded;
			public RowCollapsedNativeDelegate RowCollapsed;
			public ColumnsChangedNativeDelegate ColumnsChanged;
			public CursorChangedNativeDelegate CursorChanged;
			...
			public SelectCursorRowNativeDelegate SelectCursorRow;
			public ToggleCursorRowNativeDelegate ToggleCursorRow;
			public ExpandCollapseCursorRowNativeDelegate ExpandCollapseCursorRow;
			public SelectCursorParentNativeDelegate SelectCursorParent;
			public StartInteractiveSearchNativeDelegate StartInteractiveSearch;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkTreeViewClass> class_structs;

		static GtkTreeViewClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTreeViewClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTreeViewClass class_struct = (GtkTreeViewClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTreeViewClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTreeViewClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
