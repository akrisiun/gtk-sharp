...
#region Autogenerated code
	public partial class SimpleActionGroup : GLib.Object, GLib.IActionGroup {
		...
		static Dictionary<GLib.GType, GSimpleActionGroupClass> class_structs;

		static GSimpleActionGroupClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GSimpleActionGroupClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GSimpleActionGroupClass class_struct = (GSimpleActionGroupClass) Marshal.PtrToStructure (class_ptr, typeof (GSimpleActionGroupClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GSimpleActionGroupClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
		...
		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void g_simple_action_group_insert(IntPtr raw, IntPtr action);

		public void Insert(GLib.IAction action) {
			g_simple_action_group_insert(Handle, action == null ? IntPtr.Zero : ((action is GLib.Object) ? (action as GLib.Object).Handle : (action as GLib.ActionAdapter).Handle));
		}

		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr g_simple_action_group_lookup(IntPtr raw, IntPtr action_name);

		public GLib.IAction Lookup(string action_name) {
			IntPtr native_action_name = GLib.Marshaller.StringToPtrGStrdup (action_name);
			IntPtr raw_ret = g_simple_action_group_lookup(Handle, native_action_name);
		...
		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void g_simple_action_group_remove(IntPtr raw, IntPtr action_name);

		public void Remove(string action_name) {
			IntPtr native_action_name = GLib.Marshaller.StringToPtrGStrdup (action_name);
			g_simple_action_group_remove(Handle, native_action_name);
			GLib.Marshaller.Free (native_action_name);
		}
