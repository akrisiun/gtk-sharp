...
#region Autogenerated code
	public partial class VolumeAdapter : GLib.GInterfaceAdapter, GLib.IVolume {
		...
		public bool EjectFinish(GLib.IAsyncResult result) {
			...
			bool raw_ret = g_volume_eject_finish(Handle, result == null ? IntPtr.Zero : ((result is GLib.Object) ? (result as GLib.Object).Handle : (result as GLib.AsyncResultAdapter).Handle), out error);
			bool ret = raw_ret;
