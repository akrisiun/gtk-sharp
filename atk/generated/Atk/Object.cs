...
#region Autogenerated code
	public partial class Object : GLib.Object {
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetDescription = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetDescriptionNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetDescription;
			if (unmanaged == null) return null;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetParent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetParentNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetParent;
			if (unmanaged == null) return null;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetNChildren = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetNChildrenNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetNChildren;
		...
		{
			RefChildNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).RefChild;
			if (unmanaged == null) return null;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetIndexInParent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetIndexInParentNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetIndexInParent;
			if (unmanaged == null) return 0;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.RefRelationSet = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			RefRelationSetNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).RefRelationSet;
			if (unmanaged == null) return null;
		...
		{
			GetRoleNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetRole;
		...
		{
			GetLayerNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetLayer;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetMdiZorder = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetMdiZorderNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetMdiZorder;
			if (unmanaged == null) return 0;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.RefStateSet = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			RefStateSetNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).RefStateSet;
			if (unmanaged == null) return null;
		...
		{
			SetNameNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SetName;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.SetDescription = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			SetDescriptionNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SetDescription;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.SetParent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			SetParentNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SetParent;
			if (unmanaged == null) return;
		...
		{
			SetRoleNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).SetRole;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.Initialize = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			InitializeNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).Initialize;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.ChildrenChanged = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ChildrenChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ChildrenChanged;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.FocusEvent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			FocusEventNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).FocusEvent;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.PropertyChange = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			PropertyChangeNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).PropertyChange;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.StateChange = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			StateChangeNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).StateChange;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.VisibleDataChanged = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			VisibleDataChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).VisibleDataChanged;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.ActiveDescendantChanged = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ActiveDescendantChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ActiveDescendantChanged;
			if (unmanaged == null) return;
		...
		{
			AtkObjectClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetAttributes = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetAttributesNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetAttributes;
			if (unmanaged == null) return null;
		...
		struct AtkObjectClass {
			...
			public GetParentNativeDelegate GetParent;
			public GetNChildrenNativeDelegate GetNChildren;
			public RefChildNativeDelegate RefChild;
			public GetIndexInParentNativeDelegate GetIndexInParent;
			public RefRelationSetNativeDelegate RefRelationSet;
			public GetRoleNativeDelegate GetRole;
			public GetLayerNativeDelegate GetLayer;
			public GetMdiZorderNativeDelegate GetMdiZorder;
			public RefStateSetNativeDelegate RefStateSet;
			public SetNameNativeDelegate SetName;
			public SetDescriptionNativeDelegate SetDescription;
			public SetParentNativeDelegate SetParent;
			public SetRoleNativeDelegate SetRole;
			IntPtr ConnectPropertyChangeHandler;
			IntPtr RemovePropertyChangeHandler;
			public InitializeNativeDelegate Initialize;
			public ChildrenChangedNativeDelegate ChildrenChanged;
			public FocusEventNativeDelegate FocusEvent;
			public PropertyChangeNativeDelegate PropertyChange;
			public StateChangeNativeDelegate StateChange;
			public VisibleDataChangedNativeDelegate VisibleDataChanged;
			public ActiveDescendantChangedNativeDelegate ActiveDescendantChanged;
		...
		static Dictionary<GLib.GType, AtkObjectClass> class_structs;

		static AtkObjectClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, AtkObjectClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				AtkObjectClass class_struct = (AtkObjectClass) Marshal.PtrToStructure (class_ptr, typeof (AtkObjectClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, AtkObjectClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
